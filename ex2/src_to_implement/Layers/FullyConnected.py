...
# This is extra compared to previous exercise, The method intakes weights and bias and concatenate the data
    ...
    def initialize(self, weights_initializer, bias_initializer):
        ...
        W = weights_initializer.initialize(weight_shape, fan_in, fan_out)
        B = bias_initializer.initialize(bias_shape, fan_in, fan_out)
